...
/***/ function(module, exports, __webpack_require__) {
	...
	// import {emitter, types} from './events';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _history = __webpack_require__(349);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deprecate = __webpack_require__(350);
	
	var _deprecate2 = _interopRequireDefault(_deprecate);
	
	var _createLocation2 = __webpack_require__(351);
	...
	var _createHashHistory2 = __webpack_require__(368);
	...
	var _useBasename2 = __webpack_require__(370);
	...
	var _useQueries2 = __webpack_require__(372);
	
	var _useQueries3 = _interopRequireDefault(_useQueries2);
	
	exports.useQueries = _useQueries3['default'];
	
	var _Actions2 = __webpack_require__(352);
	...
	var _enableBeforeUnload2 = __webpack_require__(375);
	
	var _enableBeforeUnload3 = _interopRequireDefault(_enableBeforeUnload2);
	
	exports.enableBeforeUnload = _enableBeforeUnload3['default'];
	
	var _enableQueries2 = __webpack_require__(376);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parsePath = __webpack_require__(353);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extractPath = __webpack_require__(355);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ExecutionEnvironment = __webpack_require__(358);
	
	var _DOMUtils = __webpack_require__(359);
	
	var _DOMStateStorage = __webpack_require__(360);
	
	var _createDOMHistory = __webpack_require__(361);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createHistory = __webpack_require__(362);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deepEqual = __webpack_require__(363);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArguments = __webpack_require__(365);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HeaderContainer = __webpack_require__(378);
	
	var _HeaderContainer2 = _interopRequireDefault(_HeaderContainer);
	
	var _NavHeader = __webpack_require__(379);
	
	var _NavHeader2 = _interopRequireDefault(_NavHeader);
	
	var _ProductSearch = __webpack_require__(380);
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement("a", { href: "/", className: "logo", title: "ПРОДУКТУТ" }),
	      _react2.default.createElement(
	        "div",
	        { className: "search-wrapper" },
	        _react2.default.createElement("i", { className: "fa fa-search search-icon" }),
	        _react2.default.createElement("input", { className: "search-field", placeholder: "Поиск продуктов" })
	      ),
	      _react2.default.createElement(
	        "div",
	        ...
	        _react2.default.createElement(
	          "a",
	          { href: "#login", className: "user-login-btn" },
	          "Войти"
	        )
	      )
	    );
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "a",
	          { href: "#", className: "location__item" },
	          "Санкт-Петербург",
	          _react2.default.createElement("i", { className: "fa fa-angle-down location__item-down" })
	        )
	      ),
	      _react2.default.createElement(
	        "div",
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "a",
	          { href: "#", className: "cart__item" },
	          "Моя полка ",
	          _react2.default.createElement(
	            "span",
	            { className: "cart__item-circ" },
	            "646464"
	          )
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProductItem = __webpack_require__(382);
	
	var _ProductItem2 = _interopRequireDefault(_ProductItem);
	
	var _backend = __webpack_require__(383);
	...
	exports.default = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    var items = [];
	    var error = false;
	    _backend2.default.shopItem().then(function (data) {
	      console.log(data);
	  ...
	  renderItems: function renderItems() {
	    var items = this.state.items.map(function (itemData) {
	      return _react2.default.createElement(_ProductItem2.default, { key: itemData.id, data: itemData });
	    });
	    return _react2.default.createElement(
	      'div',
	  ...
	  render: function render() {
	    ...
	    if (this.state.loaded) {
	      resultContent = this.renderItems();
	    } else if (this.state.error) {
	      resultContent = this.renderError();
	    } else {
	      resultContent = this.renderLoader();
	    }
	    return _react2.default.createElement(
	      'div',
	      { className: 'product-search' },
	      _react2.default.createElement(_Toolbar2.default, null),
	      _react2.default.createElement('div', { className: 'product-search__facet' }),
	      _react2.default.createElement(
	        'div',
	        { className: 'product-search__result' },
	        resultContent
	      )
	    );
	  }
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "a",
	        { href: "#", className: "toolbar__btn toolbar__btn_active" },
	        "до 200 м"
	      ),
	      _react2.default.createElement(
	        "a",
	        { href: "#", className: "toolbar__btn" },
	        "до 500 м"
	      ),
	      _react2.default.createElement(
	        "a",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NO_IMG_SRC = 'https://upload.wikimedia.org/wikipedia/ru/a/ac/No_image_available.svg';
	var ASSETS_PREFIX = 'https://offerist.herokuapp.com/';
	
	function getDistance(data) {
	  return '' + (data.distance || 0);
	}
	
	function getFirstPrice(data) {
	  return '' + (data.firstPrice || 0);
	}
	...
	function getProductImage(data) {
	  var src = (data.product || {}).imageSrc || NO_IMG_SRC;
	  if (src.startsWith('assets')) {
	    src = ASSETS_PREFIX + src;
	  }
	  return src;
	}
	
	function getProductName(data) {
	  return (data.product || {}).name || 'Нет названия';
	}
	...
	exports.default = _react2.default.createClass({
	  ...
	  handleAddClick: function handleAddClick() {
	    alert('Добавить продукт ' + this.props.data.id);
	  },
	  render: function render() {
	    var data = this.props.data;
	    return _react2.default.createElement(
	      'div',
	      { className: 'product-item product-item_result' },
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'product-item__price-header' },
	        _react2.default.createElement('div', { className: 'arrow-left' }),
	        _react2.default.createElement('div', { className: 'circle' }),
	        _react2.default.createElement(
	          'span',
	          { className: 'product-item__price-header_through' },
	          _react2.default.createElement(
	            'span',
	            null,
	            getFirstPrice(data)
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'product-item__price-footer' },
	        _react2.default.createElement('div', { className: 'arrow-left' }),
	        _react2.default.createElement('div', { className: 'circle' }),
	        _react2.default.createElement(
	          'span',
	...
	exports.default = {
	  shopItem: function shopItem() {
	    return new Promise(function (resolve, reject) {
	      fetch('https://offerist.herokuapp.com/api/v0.0.1/json/shopitem?populate=shop,product').then(function (response) {
